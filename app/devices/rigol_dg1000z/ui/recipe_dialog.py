...
class RigolNodeEditorDialog(FluentRecipeDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self.level_mode = ComboBox(carrier)
        ...
        carrier_scroll = ScrollArea(surface)
        ...
        actions_frame = CardWidget(surface)
        ...
        self.open_roi_button.setParent(actions_frame)
        ...
        footer = QHBoxLayout()
        footer.addStretch(1)
        self.apply_button = PrimaryPushButton("Apply Rigol configuration", surface)
